...
<div class="modal fade bd-example-modal-sm" id="personas" tabindex="-1">
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control" id="IDENTIDAD" name="IDENTIDAD" placeholder="Ingrese numero de identidad de la persona">
    </div>
...
<div class="mb-3">
  ...
  <input type="date" class="form-control" id="FECHA_SALIDA" name="FECHA_SALIDA" placeholder="Ingrese fecha de salida">
</div>
...
<table cellspacing="10" cellpadding="10" class="Table table-hover table-hover table-responsive table-dark table-striped mt-1" style="border:2px solid lime;">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
            @if ($personas['FECHA_SALIDA'] !== null)
                {{strftime('%d de %B de %Y', strtotime($personas['FECHA_SALIDA']))}}
            @endif
        </td>
            <td>
