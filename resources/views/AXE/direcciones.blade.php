...
@section('content')
<button type="button" class="btn btn-success" data-toggle="modal" data-target="#direcciones">+ Nuevo</button>

<div class="modal fade bd-example-modal-sm" id="direcciones" tabindex="-1">
