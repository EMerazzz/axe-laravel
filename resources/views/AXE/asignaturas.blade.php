...
<div class="modal fade bd-example-modal-sm" id="asignaturas-delete-{{$asignaturas['COD_ASIGNATURA']}}" tabindex="-1">
                <div class="modal-dialog">
                    <div class="modal-content">
                    <div class="modal-header">
    ...
    <div class="modal-footer">
      <form action="{{ url('asignaturas/delete') }}" method="post">
                        @csrf
      <input type="hidden" class="form-control" name="COD_ASIGNATURA" value="{{ $asignaturas['COD_ASIGNATURA'] }}">
