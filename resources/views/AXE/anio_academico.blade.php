        ...
        <tr>
            ...
            <td>
                ...
                <button value="editar" title="Eliminar" class="btn btn-outline-danger" type="button" data-toggle="modal"
                            data-target="#anio_academico-delete-{{$anio_academico['COD_ANIO_ACADEMICO']}}">
...
<div class="modal fade bd-example-modal-sm" id="anio_academico-delete-{{$anio_academico['COD_ANIO_ACADEMICO']}}" tabindex="-1">
                <div class="modal-dialog">
                    <div class="modal-content">
                    <div class="modal-header">
    ...
    <div class="modal-footer">
      <form action="{{ url('anio_academico/delete') }}" method="post">
                        @csrf
      <input type="hidden" class="form-control" name="COD_ANIO_ACADEMICO" value="{{ $anio_academico['COD_ANIO_ACADEMICO'] }}">
